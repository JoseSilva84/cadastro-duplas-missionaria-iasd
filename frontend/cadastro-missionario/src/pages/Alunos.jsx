        ...
        <section className="card">
          ...
          <div className="grid grid-cols-1 gap-3">
            {alunosFiltrados.map((aluno) => {
              ...
              >
                <div className="grid grid-cols-1 gap-4 p-4 lg:grid-cols-[minmax(0,1fr)_8rem] lg:items-center xl:grid-cols-[minmax(0,1fr)_9rem]">
                  <div className="grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-[minmax(8rem,1fr)_7rem_minmax(8rem,0.85fr)_minmax(12rem,1fr)] lg:items-center xl:grid-cols-[minmax(10rem,1fr)_8.5rem_minmax(9rem,0.9fr)_minmax(11rem,1fr)_minmax(11rem,1fr)]">
                    ...
                    <div className="min-w-0">
                      ...
                      <p className="mt-1 hidden truncate text-[10px] leading-tight text-gray-400 lg:block xl:hidden">{aluno.distrito}</p>
                      <p className="hidden truncate text-[10px] leading-tight text-gray-400 lg:block xl:hidden">{aluno.regiao}</p>
                    </div>
                    ...
                    <div className="min-w-0">
                      ...
                      <button
                        type="button"
                        className="mt-3 inline-flex items-center justify-center rounded-lg border border-[#1A3A6B]/25 bg-white px-3 py-2 text-xs font-bold text-[#1A3A6B] shadow-sm transition hover:border-[#1A3A6B] hover:bg-[#1A3A6B] hover:text-white focus:outline-none focus:ring-2 focus:ring-[#C9963A]/35 lg:mt-2"
                      ...
                      <button
                        type="button"
                        className="mt-2 hidden rounded-lg border border-red-200 px-3 py-2 text-xs font-semibold text-red-700 transition hover:border-red-700 hover:bg-red-700 hover:text-white lg:block xl:hidden"
                        onClick={() => abrirEncerramento(aluno)}
                      >
                        Encerrar Estudo
                      </button>
                      <div className="mt-1 hidden min-w-0 lg:block xl:hidden">
                        <p className="truncate text-[10px] font-semibold leading-tight text-gray-600">{aluno.igreja}</p>
                  ...
                  <div className="flex lg:justify-end">
                    <div className="w-full space-y-2 lg:w-32 xl:w-40">
                      <button type="button" className="btn-outline w-full px-3 py-2 text-xs" onClick={() => navigate(caminhoDetalhes(aluno))}>
                        Detalhes
                      </button>
                      <button
                        type="button"
                        className="w-full rounded-lg border border-red-200 px-3 py-2 text-xs font-semibold text-red-700 transition hover:border-red-700 hover:bg-red-700 hover:text-white lg:hidden xl:block"
                        onClick={() => abrirEncerramento(aluno)}
                      >
                        Encerrar Estudo
                      </button>
