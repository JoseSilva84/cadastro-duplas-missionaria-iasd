...
5 No relatório do administrador e super administrador não aparece as datas de nascimento e de batismo de cada membro da dupla. Preciso que apareçam  esses dois itens para os administradores. Na verdade, para os administradores, eu preciso que todas as infomações nos cadastros sejam exibidas para eles. (Feito)
