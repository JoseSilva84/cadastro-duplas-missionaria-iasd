  ...
  async findById(id) {
    return prisma.usuario.findUnique({
      ...
      select: {
        ...
        igreja: { select: { id: true, nome: true, distritoId: true, distrito: { select: { id: true, nome: true, regiaoId: true } } } },
        dupla: {
          select: {
            id: true,
            liderNome: true,
            ...
            distritoId: true,
            igrejaId: true,
            distrito: { select: { regiaoId: true } },
            igreja: { select: { id: true, nome: true, distrito: { select: { regiaoId: true } } } },
          },
        },
      },
    });
