...
const DuplaService = {
  ...
  async criar(data, usuario) {
    ...
    const novaDupla = await DuplaModel.create({
      ...
      metaBatismos: data.metaBatismos ? Number(data.metaBatismos) : 0,
      metaEstudosBiblicos: data.metaEstudosBiblicos ? Number(data.metaEstudosBiblicos) : 0,
  ...
  async atualizar(id, data, usuario) {
    ...
    const dadosAtualizados = {
      ...
      metaBatismos: data.metaBatismos !== undefined ? Number(data.metaBatismos) : undefined,
      metaEstudosBiblicos: data.metaEstudosBiblicos !== undefined ? Number(data.metaEstudosBiblicos) : undefined,
      classificacaoDupla: classificacao.classificacaoDupla,
      atividadeDupla: classificacao.atividadeDupla,
      levouPessoaBatismo: classificacao.levouPessoaBatismo,
      jaDeuEstudoBiblico: classificacao.jaDeuEstudoBiblico,
